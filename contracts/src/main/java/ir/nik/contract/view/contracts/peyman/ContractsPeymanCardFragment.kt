package ir.nik.contract.view.contracts.peyman
...
import ir.nik.contract.data.network.model.request.ContractPeymanCardReportRequest
...
internal class ContractsPeymanCardFragment(
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_peyman_card_contracts, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        viewModel.getPeymanCardReport(
            ContractPeymanCardReportRequest().also { request ->
                request.ccdId = 0
                request.jsonParameters = peymanCardJson(contractId)
    ...
    companion object{
        val TAG = "$APP_NAME: ${ContractsPeymanCardFragment::class.java.simpleName}"
    }
}