package ir.nik.contract.view.contracts.status
...
import ir.nik.contract.data.network.model.request.ContractStatusRequest
...
internal class ContractsStatusFragment(
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_contract_status_contracts, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.getContractStatus(
            ContractStatusRequest().also { request ->
                request.ccId = 0
                request.jsonParameters = contractStatusJson(contractId)
